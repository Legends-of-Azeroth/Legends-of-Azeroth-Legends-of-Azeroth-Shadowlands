...
enum CreatureStaticFlags6
{
    ...
    CREATURE_STATIC_FLAG_6_UNK11                               = 0x00000800, // "Always, ALWAYS tries to stand right on top of his move to target. ALWAYS!!", toggleable by 'Set "Always Stand on Target" flag for unit(s)' or not same?
